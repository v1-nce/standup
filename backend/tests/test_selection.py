...
from models import Candidate, Commit, FileFacts, Index, Scope
from selection import choose
from selection.diversity import _overlap, ordered
from selection.score import WEIGHTS, relevance
from selection.signals import SIGNALS, measure
