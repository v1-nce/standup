...
from errors import InvalidInput, NotFound, StandupError, Upstream
from models import Project, ProjectPaths, Source, SourceKind
...
class ProjectStore:
    ...
    def create(self, name: str, location: str) -> Project:
        ...
        for directory in (paths.root, paths.index, paths.chat, paths.decks, paths.cache):
